...
function build(directory, config, parameters, level, seed)
  ...
  if config.baseOffset then
    ...
    construct(config, "animationCustom", "animatedParts", "parts", "middlebright", "properties")
    config.animationCustom.animatedParts.parts.middle.properties.offset = config.baseOffset
    config.animationCustom.animatedParts.parts.middlebright.properties.offset = config.baseOffset
