...
function ChargeFire:charge()
  ...
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) do
    ...
    if self.chargeLevelPrev ~= self:currentChargeLevel() then
      ...
      animator.playSound(self.chargeLevel.chargedSound or "charged")
...
function ChargeFire:fireProjectile()
  ...
  local params = copy(self.chargeLevel.projectileParameters or config.getParameter("primaryAbility").projectileParameters or {})
