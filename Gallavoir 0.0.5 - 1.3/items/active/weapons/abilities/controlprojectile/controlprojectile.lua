...
function ControlProjectile:createProjectiles()
  ...
  pOffset = vec2.rotate(pOffset, fireDirection * self.projectileRotation * math.pi / 180)
  pOffset = vec2.rotate(pOffset, -1 * (2 * math.pi) / self.projectileAngleCount * ((self.projectileCount - 1) / 2))
  ...
  for i = 1, pCount do
    ...
    pOffset = vec2.rotate(pOffset, (2 * math.pi) / self.projectileAngleCount)
  end
end
